...
export default function AboutPage() {
  return (
    <SectionLayout slug="about">
      ...
      <p>Outside of class: lifting four times a week and easy runs on the strand when the marine layer lifts, mostly nonfiction reading with sci-fi as relief, essays I write for myself just to think on paper, cooking Eastern European staples from my mom&apos;s kitchen — borscht, pelmeni, the occasional ambitious bread — a long list of half-finished side projects (the list grows faster than I can ship, and I&apos;m okay with that), and a daily rhythm of bullet chess on Lichess and slow pour-overs in the morning.</p>
    </SectionLayout>
  );
}
